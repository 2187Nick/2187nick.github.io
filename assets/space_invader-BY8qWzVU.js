...
function SpaceInvaders() {
  ...
  reactExports.useEffect(() => {
    ...
    console.log(`Initial gameOver: ${gameOver2}, gameWon: ${gameWon}, finalScore: ${finalScore}`);
    return () => {
      console.log = originalLog;
      debugDiv == null ? void 0 : debugDiv.remove();
    };
  }, [gameOver2, gameWon, finalScore]);
...
//# sourceMappingURL=space_invader-BY8qWzVU.js.map
